...
/**
 * Authentication utility class for base64 encoding/decoding and hashing of user
 * passwords.
 */
public class AuthenticationUtils {
	 ...
	 *
	 * @param validCodeCharacters
	 *            valid code characters
	 * @param length
	 *            length of code to generate. Length of password must be more
	 *            than 0.
	...
	public static String generateCode(String validCodeCharacters, int length) {
		...
		while (sBuilder.length() < length) {
			sBuilder.append(validCodeCharacters.charAt(rand.nextInt(validCodeCharacters.length())));
		}
	...
	public static String generateCode(int length) {
		return AuthenticationUtils.generateCode("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234567", length);
	}
	...
	public static String base64Decode(String base64Encoding) {
		...
		return new String(Base64.getDecoder().decode(base64Encoding.getBytes()));
